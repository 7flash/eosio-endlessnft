...
sed -i "s/#include \"class1.hpp\"/#include \"$Contract.hpp\"/" ./test/test-contract_name.cpp
...
sed -i "s/contract_name.wasm/$Contract.wasm/" ./test/test-contract_name.cpp
