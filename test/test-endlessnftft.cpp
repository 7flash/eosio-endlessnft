...
{
    t.create_code_account(endlessnftft::default_contract_account);
    t.set_code(endlessnftft::default_contract_account, "artifacts/endlessnftft.wasm");
}
...
TEST_CASE("Short description of first test", "[test]")
{
    ...
    expect(
        self.trace<endlessnftft::actions::startpool>(
            pool_id
        ),
        nullptr
    );
    ...
    //     {2, 50}
    // };
    // map<name, uint8_t> schemas = {
    // };

    // expect(
    //     self.trace<endlessnftft::actions::createpool>(
    //         token,
    //         templates,
    //         schemas
    //     ),
    ...
    // expect(alice.trace<endlessnftft::actions::sayhi>(), nullptr);

    // expect(alice.trace<endlessnftft::actions::sayhialice>("alice"_n), nullptr);

    // expect(alice.trace<endlessnftft::actions::sayhialice>("bob"_n), "You may only say hi to Alice!");
